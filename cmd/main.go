...
import (
	...
	"github.com/maczg/fanet-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(fanetv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d5ab0e50.restart.eu",
	...
	if err = (&controller.UAVReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "UAV")
		os.Exit(1)
	}
